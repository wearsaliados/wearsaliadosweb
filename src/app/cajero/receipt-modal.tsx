    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      <div className="relative w-full max-w-sm rounded-2xl bg-white shadow-2xl">
        <button
          ...
          onClick={onClose}
          aria-label="Cerrar"
          className="absolute right-3 top-3 flex h-8 w-8 items-center justify-center rounded-full bg-white/10 text-lg text-wears-cream hover:bg-white/20 hover:text-white"
        >
          ✕
        </button>
        ...
        <div className="flex flex-col gap-3 border-t border-wears-tan/20 px-6 py-4">
